...
export type TargetSlot = { dayIndex: number; startHour: number; endHour: number };
      ...
      <DialogContent>
        <Stack spacing={1} sx={{ mt: 1 }}>
          ...
          <Typography variant="body2">
            {event.title}（{event.court}）: {event.startHour}:00 → {target.startHour}
          ...
          <List dense>
            ...
            <ListItem>
              <ListItemText primary={`関係者通知: ${notifications.join(" / ")}`} />
            </ListItem>
          </List>
