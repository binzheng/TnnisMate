"use client";
import { Box, Typography, IconButton, Stack, Badge } from "@mui/material";
  ...
  return (
    <Box>
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 2 }}>
        <IconButton onClick={handlePrevMonth} aria-label="前の月">
          <ChevronLeft />
        </IconButton>
        <Typography variant="h6">{formatMonth(date)}</Typography>
        <IconButton onClick={handleNextMonth} aria-label="次の月">
          <ChevronRight />
        </IconButton>
      </Stack>
          ...
          {WEEKDAY_LABELS.map((label, i) => (
            <Box
              ...
              sx={{
                ...
                textAlign: "center",
                fontWeight: 600,
                color: i === 0 ? "error.main" : i === 6 ? "info.main" : "text.primary",
              }}
            >
              {label}
            </Box>
