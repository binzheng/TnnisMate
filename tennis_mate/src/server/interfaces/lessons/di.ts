...
import { BulkChangeReservationsUseCase, CreateSlotUseCase, DeleteSlotUseCase, ListSlotsUseCase, SearchCandidateSlotsUseCase, UpdateSlotUseCase } from "~/server/core/usecases/lessons/usecases";
...
export function createLessonUseCases(db: PrismaClient) {
  ...
  return {
    ...
    bulkChangeReservations: new BulkChangeReservationsUseCase(repo, authz, audit),
  } as const;
}
