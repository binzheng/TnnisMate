...
class Repo implements AdminAnalyticsRepository {
  async reservationsCount(){ return 10; }
  async lessonReservationsTotal(){ return 30; }
  async cancellationsCount(){ return 2; }
  async lessonSlotsCapacitySum(){ return 60; }
  async lessonAveragePrice(){ return 2000; }
}
